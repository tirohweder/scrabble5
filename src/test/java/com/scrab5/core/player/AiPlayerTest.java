...
class AiPlayerTest {
  ...
  void getSpotsFreeTest() {
    /*
     * GameBoard g2 = new GameBoard(); g2.placeTileTest(new Tile("A ", 1), 7, 3);
     * g2.placeTileTest(new Tile("A ", 1), 7, 4); g2.placeTileTest(new Tile("A ", 1), 8, 3);
     * g2.finishTurn(); test.getSpotsFree(3, 7, g2); assertEquals(0, test.counterLeft);
     * assertEquals(0, test.counterRight); assertEquals(0, test.counterDown); assertEquals(0,
     * test.counterUp);
     * 
     * GameBoard g3 = new GameBoard(); g3.placeTileTest(new Tile("A ", 1), 5, 6);
     * g3.placeTileTest(new Tile("A ", 1), 5, 7); g3.placeTileTest(new Tile("A ", 1), 7, 6);
     * g3.finishTurn(); test.getSpotsFree(6, 5, g3); assertEquals(0, test.counterLeft);
     * assertEquals(0, test.counterRight); assertEquals(0, test.counterDown); assertEquals(5,
     * test.counterUp);
     * 
     * GameBoard g4 = new GameBoard(); g4.placeTileTest(new Tile("A ", 1), 7, 6);
     * g4.placeTileTest(new Tile("A ", 1), 7, 7); g4.placeTileTest(new Tile("A ", 1), 7, 8);
     * g4.placeTileTest(new Tile("A ", 1), 7, 9); g4.placeTileTest(new Tile("A ", 1), 7, 10);
     * 
  ...
  void countScore() {
    /*
     * ArrayList<Tile> testList = new ArrayList<>(); testList.add(new Tile("W", 4, 7, 7));
     * testList.add(new Tile("E", 1, 7, 8)); testList.add(new Tile("L", 1, 7, 9)); testList.add(new
     * Tile("L", 1, 7, 10));
     * 
     * ArrayList<Tile> testList2 = new ArrayList<>(); testList2.add(new Tile("H", 4, 11, 7));
     * testList2.add(new Tile("I", 1, 12, 7)); testList2.add(new Tile("P", 3, 13, 7));
     * testList2.add(new Tile("P", 3, 14, 7));
     * 
     * ArrayList<ArrayList<Tile>> possibleWords = new ArrayList<>(); possibleWords.add(testList);
     * possibleWords.add(testList2);
     * 
     * ArrayList<Integer> testResult = new ArrayList<>(); testResult.add(14); testResult.add(45);
     * 
     ...
     * ArrayList<Integer>(); scoreList.add(10); scoreList.add(4); assertEquals(scoreList,
     * AiPlayer.countScore(new GameBoard(), tilesList));
     * 
     */
  }
