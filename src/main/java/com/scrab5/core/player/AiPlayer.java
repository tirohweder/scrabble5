...
public class AiPlayer extends Player {
  ...
  /*
   * 
   * // Code from @author hraza was supposed to do the same thing as getSpotsFree2() but doesnt
   * work. // Keeping it here to show he did work.
   * 
   * 
   ...
   * && y == 14 && g.isSpotFree(y, x + 1) && !g.isSpotFree(y - 1, x + 1)) { counterRight = -1; } if
   * (x - 1 >= 0 && !g.isSpotFree(y, x - 1)) { counterRight = -1; }
   * 
   ...
   * && g.isSpotFreeOld(y - 1, x - 1 - counterLeft) && g.isSpotFreeOld(y + 1, x - 1 - counterLeft))
   * { counterLeft++; // System.out.println("y=" + y + "; counterLeft =" + counterLeft); } while (y
   * == 0 && x - 2 - counterLeft >= 0 && g.isSpotFreeOld(y, x - 1 - counterLeft) &&
   * g.isSpotFreeOld(y, x - 2 - counterLeft) && g.isSpotFreeOld(y + 1, x - 1 - counterLeft)) {
   * counterLeft++; } while (y == 0 && x - 2 - counterLeft == -1 && g.isSpotFreeOld(y, x - 1 -
   * counterLeft) && g.isSpotFreeOld(y + 1, x - 1 - counterLeft)) { counterLeft++; } while (y == 14
   * && x - 2 - counterLeft >= 0 && g.isSpotFreeOld(y, x - 1 - counterLeft) && g.isSpotFreeOld(y, x
   * - 2 - counterLeft) && g.isSpotFreeOld(y - 1, x - 1 - counterLeft)) { counterLeft++; } while (y
   * == 14 && x - 2 - counterLeft == -1 && g.isSpotFreeOld(y, x - 1 - counterLeft) &&
   * g.isSpotFreeOld(y - 1, x - 1 - counterLeft)) { counterLeft++; } if (x - 2 >= 0 &&
   * g.isSpotFree(y, x - 1) && !g.isSpotFree(y, x - 2)) { counterLeft = -1; }
   * 
   ...
   * y == 14 && g.isSpotFree(y, x - 1) && !g.isSpotFree(y - 1, x - 1)) { counterLeft = -1; } if (x +
   * 1 <= 14 && !g.isSpotFree(y, x + 1)) { counterLeft = -1; }
   * 
   * // Checking for free Spots under the Position x,y while (y + 2 + counterDown <= 14 && x > 0 &&
   * x < 14 && g.isSpotFreeOld(y + 1 + counterDown, x) && g.isSpotFreeOld(y + 2 + counterDown, x) &&
   * g.isSpotFreeOld(y + 1 + counterDown, x + 1) && g.isSpotFreeOld(y + 1 + counterDown, x - 1)) {
   * counterDown++; } while (y + 2 + counterDown == 15 && x > 0 && x < 14 && g.isSpotFreeOld(y + 1 +
   * counterDown, x) && g.isSpotFreeOld(y + 1 + counterDown, x + 1) && g.isSpotFreeOld(y + 1 +
   * counterDown, x - 1)) { counterDown++; }
   * 
   ...
   * counterDown, x) && g.isSpotFreeOld(y + 1 + counterDown, x + 1)) { counterDown++; } while (y + 2
   * + counterDown <= 14 && x == 14 && g.isSpotFreeOld(y + 1 + counterDown, x) && g.isSpotFreeOld(y
   * + 2 + counterDown, x) && g.isSpotFreeOld(y + 1 + counterDown, x - 1)) { counterDown++; } while
   * (y + 2 + counterDown == 15 && x == 14 && g.isSpotFreeOld(y + 1 + counterDown, x) &&
   * g.isSpotFreeOld(y + 1 + counterDown, x - 1)) { counterDown++; } if (y + 2 <= 14 &&
   * g.isSpotFree(y + 1, x) && !g.isSpotFree(y + 2, x)) { counterDown = -1; }
   * 
   * if (y + 2 == 15 && x > 0 && x < 14 && g.isSpotFree(y + 1, x) && (!g.isSpotFree(y + 1, x + 1) ||
   * !g.isSpotFree(y + 1, x - 1))) { counterDown = -1; } if (y + 2 == 15 && x == 0 && g.isSpotFree(y
   * + 1, x) && !g.isSpotFree(y + 1, x + 1)) { counterDown = -1; } if (y + 2 == 15 && x == 14 &&
   * g.isSpotFree(y + 1, x) && !g.isSpotFree(y + 1, x - 1)) { counterDown = -1; }
   * 
   ...
   * counterUp == -1 && g.isSpotFreeOld(y - 1 - counterUp, x) && g.isSpotFreeOld(y - 1 - counterUp,
   * x + 1) && g.isSpotFreeOld(y - 1 - counterUp, x - 1)) { counterUp++; // System.out.println("y="
   * + y + "; counterUp =" + counterUp); } while (y - 2 - counterUp >= 0 && x == 0 &&
   * g.isSpotFreeOld(y - 1 - counterUp, x) && g.isSpotFreeOld(y - 2 - counterUp, x) &&
   * g.isSpotFreeOld(y - 1 - counterUp, x + 1)) { counterUp++; } while (y - 2 - counterUp == -1 && x
   * == 0 && g.isSpotFreeOld(y - 1 - counterUp, x) && g.isSpotFreeOld(y - 1 - counterUp, x + 1)) {
   * counterUp++; } while (y - 2 - counterUp >= 0 && x == 14 && g.isSpotFreeOld(y - 1 - counterUp,
   * x) && g.isSpotFreeOld(y - 2 - counterUp, x) && g.isSpotFreeOld(y - 1 - counterUp, x - 1)) {
   * counterUp++; } while (y - 2 - counterUp == -1 && x == 14 && g.isSpotFreeOld(y - 1 - counterUp,
   * x) && g.isSpotFreeOld(y - 1 - counterUp, x - 1)) { counterUp++; }
   * 
   * if (y - 2 >= 0 && g.isSpotFree(y - 1, x) && !g.isSpotFree(y - 2, x)) { counterUp = -1; }
   * 
   * if (y - 2 == -1 && x > 0 && x < 14 && g.isSpotFree(y - 1, x) && (!g.isSpotFree(y - 1, x - 1) ||
   * !g.isSpotFree(y - 1, x + 1))) { counterUp = -1; } if (y - 2 == -1 && x == 0 && g.isSpotFree(y -
   * 1, x) && !g.isSpotFree(y - 1, x + 1)) { counterUp = -1; } if (y - 2 == -1 && x == 14 &&
   * g.isSpotFree(y - 1, x) && !g.isSpotFree(y - 1, x - 1)) { counterUp = -1; }
   * 
